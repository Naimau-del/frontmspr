<template>
  <div class="container mt-4">
    ...
    <div v-if="selectedUser" class="card mt-4 border-primary">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Détails de l'utilisateur</h5>
        <button type="button" class="btn btn-sm btn-outline-secondary" @click="selectedUser = null">Fermer</button>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
...
const viewUserDetails = (user: User) => {
  selectedUser.value = selectedUser.value?.User_ID === user.User_ID ? null : user
}
